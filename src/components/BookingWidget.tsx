      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.07)" }}>
        <div className="text-center mb-5">
          <div className="w-14 h-14 mx-auto mb-3 flex items-center justify-center rounded-full" style={{ background: "#ecfdf5" }}>
            <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="border border-gray-100 rounded-xl p-4 bg-gray-50">
          ...
          <div className="flex flex-col gap-2">
            ...
            {icsUrl && (
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
              </svg> {b.appleCal}
              </a>
            )}
