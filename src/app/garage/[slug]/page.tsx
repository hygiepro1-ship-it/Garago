    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          ...
          {/* Badge Ambassadeur — visible au propriétaire uniquement */}
          {isOwner && ((garage as any).isAmbassador ? (
            <div className="rounded-2xl overflow-hidden"
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    "Garage vérifié et recommandé",
                    "Avis clients authentiques",
                    "Partenaire prioritaire Garago",
                    "Engagement qualité reconnu",
                  ].map((label) => (
            ...
            <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #e2e8f0", background: "#f8fafc" }}>
              <div className="px-5 py-4 flex items-center gap-3" style={{ borderBottom: "1px solid #f1f5f9" }}>
                ...
                <div>
                  <p className="text-sm font-black text-gray-700">Programme Ambassadeur</p>
                  <p className="text-xs text-gray-400">Statut non encore obtenu</p>
                </div>
              </div>
              <div className="px-5 py-4 space-y-3">
                <p className="text-xs text-gray-500 leading-relaxed">
                  Les garages Ambassadeurs Garago bénéficient d&apos;avantages exclusifs réservés aux partenaires les plus engagés de la plateforme.
                </p>
                <div className="space-y-2">
                  {[
                    "Priorité dans les résultats de recherche",
                    "Badge de confiance visible par les clients",
                    "Réduction permanente sur l'abonnement",
                ...
                <div className="pt-2" style={{ borderTop: "1px solid #f1f5f9" }}>
                  <p className="text-xs text-gray-400 italic">Ce statut s&apos;obtient en parrainant d&apos;autres garages sur Garago.</p>
                </div>
              </div>
            </div>
          ))}
