...
export const VEHICLE_MODELS: Record<string, string[]> = {
  ...
  "Bugatti":      ["Chiron", "Chiron Pur Sport", "Chiron Super Sport", "Mistral", "Tourbillon"],
  ...
  "Citroën":   ["C3", "C3 Aircross", "C5 X", "ë-C3", "Berlingo", "Jumpy"],
  ...
  Fiat:        ["500", "500X", "500L"],
  "Lada":      ["Niva", "Niva Travel", "Vesta", "Granta", "Largus"],
  "Lancia":    ["Ypsilon", "Delta"],
  Opel:        ["Astra", "Corsa", "Mokka", "Grandland", "Insignia", "Crossland"],
  Peugeot:     ["208", "308", "408", "2008", "3008", "5008", "e-208", "e-2008"],
  Renault:     ["Clio", "Megane", "Arkana", "Austral", "Captur", "Scenic", "Zoe", "Megane E-Tech"],
  "SEAT":      ["Ibiza", "Leon", "Arona", "Ateca", "Tarraco"],
  "Škoda":     ["Octavia", "Superb", "Fabia", "Kamiq", "Karoq", "Kodiaq", "Enyaq"],
  "Smart":     ["#1", "#3", "fortwo", "forfour"],
  "SsangYong": ["Tivoli", "Korando", "Musso", "Rexton", "Torres"],
  Polestar:    ["2", "3", "4"],
  Rivian: ["R1T", "R1S"],
